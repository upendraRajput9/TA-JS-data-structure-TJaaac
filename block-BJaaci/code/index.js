...
console.log(movies[0].actors[movies[0].actor.length-1]);
...
console.log(movies[2].actors[movies[2].actor.length-1]);
...
for(let gener of movies[0].geners){
  console.log(gener);
}
// 19. Log all the genres of the second movie one by one
for(let gener of movies[1].geners){
  console.log(gener);
}
